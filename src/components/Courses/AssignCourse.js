...
import { actionAssignCourse } from '../../actions/actionAssignCourse';
...
export class AssignCourse extends Component {
    ...
    render() {
        ...
        console.log(this.props.getUsersReducer)
...
export default withStyles(combinedStyles)(
    connect(mapStateToProps, { actionGetUserDetailsByVendor, actionGetAllUsers, actionAssignCourse })(AssignCourse)
)