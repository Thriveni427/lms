...
import StudentsMonth from './partials/StudentsMonth';
const data = [
  {
            ...
            <div className="col">
              <div className="card">
                <div className="card-header d-flex align-items-center border-0">
                  <h3 className="margin-0 padding-0">Admin Dashboard</h3>
                </div>
...
export default withStyles(combinedStyles)(
  connect(mapStateToProps, { actionGetLearnerStatus, actionGetActiveCourseStatus, actoinGetCourseCompletedStatus })(Dashboard)
)