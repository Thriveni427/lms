      ...
      <main className="c-mainContainer h-100vh d-flex justify-content-center align-items-center">
        ...
        <div className="loginForm">
          ...
          <div className="mt-5" align="center">
            {
              (loginReducer.loginAuth === false && loginReducer.loginAuthenticated === false && loginReducer.loginAuthernticating === false && loginReducer.loginAuthError !== null)
                ?
                <h5 className="loginFormText">{loginReducer.loginAuthError}</h5>
                :
                null
            }
          </div>
