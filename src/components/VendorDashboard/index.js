...
import VendorStudentMonth from './partial/VendorStudentMonth';
            ...
            <div className="col">
              <div className="card">
                <div className="card-header d-flex align-items-center border-0">
                  <h3 className="margin-0 padding-0">Vendor Dashboard</h3>
                </div>
...
export default withStyles(combinedStyles)(
  connect(mapStateToProps, { actionGetLearnerStatus, actionGetActiveCourseStatus, actoinGetCourseCompletedStatus })(VendorDashboard)
)