...
import SuperAdminTopUsers from './partials/SuperAdminTopUsers';
import SuperAdminCourseRevenue from './partials/SuperAdminCourseRevenue';
...
import SuperAdminStudentsMonth from './partials/SuperAdminStudentsMonth';
...
class SuperAdminDashboard extends Component {
  ...
  render() {
    let { getLearnerReducer, getActiveCourseStatusReducer, getCourseCompletedStatusReducer, getVendorReducer } = this.props;
            ...
            <div className="col">
              <div className="card">
                <div className="card-header d-flex align-items-center border-0">
                  <h3 className="margin-0 padding-0">SuperAdmin Dashboard</h3>
                </div>
                  ...
                  <div className="row">
                    <div className="col-xl-8 col-lg-8 col-md-12 col-12 order-first">
                      <h2 className="jr-entry-title d-flex flex-row">
                        Top Vendors
                        <span className="text-primary jr-font-weight-medium jr-fs-md pointer ml-auto d-none d-sm-block"><a href="/vendors">Go to vendors list </a><i className="zmdi zmdi-long-arrow-right jr-fs-xxl ml-2 d-inline-block align-middle"></i></span>
                      </h2>
                      <ul className="c-vendorsList">
                        {
                          getVendorReducer.vendorsData.map((item, index) => {
                            return (
                              <li className="c-vendorsList__item">
                                <div className="c-vendorsInfo">
                                  <div className="c-vendorsInfo__thumb"><img alt=".." src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHAf30UUKrmHkdt4dRJIanGc6pzFPVaRQTmG5gF1f-sfLm3yTK&s" width="100%" height="100" /></div>
                                  <div className="c-vendorsInfo__content">
                                    <h5 className="mb-0 mt-5 text-truncate text-white">{item.VendorName}</h5>
                                    <p className="mb-0"><i className="zmdi zmdi-star text-orange"></i> 5.0<span>|</span> 27 Deals</p>
                                  </div>
                                </div>
                              </li>
                            )
...
export default withStyles(combinedStyles)(
  connect(mapStateToProps, { actionGetLearnerStatus, actionGetActiveCourseStatus, actoinGetCourseCompletedStatus, actionGetVendors })(SuperAdminDashboard)
)